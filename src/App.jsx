...
function AppWithAuth() {
  ...
  return (
    <Routes>
      ...
      <Route path="/signup/host" element={<SignupFlow presetRole="host" />} />
      <Route path="/signup/cleaner" element={<SignupFlow presetRole="cleaner" />} />
      <Route path="/signup/join" element={<SignupFlow presetRole="teammate" entry="join" />} />
      <Route path="/cleaner/signup" element={<Navigate to="/signup/cleaner" replace />} />
      <Route path="/invite/:token" element={<InviteLanding />} />
      <Route path="/invite/:token/expired" element={<InviteExpiredLanding />} />
