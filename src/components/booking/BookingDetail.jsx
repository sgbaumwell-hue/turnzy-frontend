  ...
  return (
    <div className="p-6 max-w-xl">
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h2 className="text-2xl font-bold text-warm-800">{b.property_name || 'Turnover'}</h2>
          <p className="text-sm text-warm-400 mt-1">{fmtDateLong(b.checkout_date)}</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-5">
        ...
        <div className="bg-warm-100 rounded-xl p-4">
          ...
          <div className="text-xs text-warm-400">{fmtDateLong(b.checkin_date)}</div>
        </div>
      </div>
