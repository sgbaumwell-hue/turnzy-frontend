...
function Toggle({ checked, onChange, label }) {
  return (
    <label className="flex items-center justify-between py-3 px-4 cursor-pointer hover:bg-warm-50 rounded-lg">
...
export function Notifications() {
  ...
  return (
    <div>
      ...
      <div className="bg-white border border-warm-200 rounded-xl overflow-hidden mb-5">
        <div className="px-4 py-2.5 border-b border-warm-100">
