...
export function HostActivity() {
  ...
  const rawActivities = Array.isArray(data?.data?.activity) ? data.data.activity : [];
          ...
          {!isLoading && !isError && activities.map((a, i) => {
            ...
            const row = (
              <div
                ...
                onClick={isTappable ? () => navigate(`/bookings/detail/${a.booking_id}`) : undefined}
              >
